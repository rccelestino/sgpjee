package br.com.efinoveworks.sgpjee.exception;
			...
			try {
				...
				if (exeption != null && exeption.getMessage() != null
					...
					FacesContext.getCurrentInstance().addMessage("msg", new FacesMessage(FacesMessage.SEVERITY_WARN,
							"O Registo não pode ser removido por está associado", ""));
					...
					// exibe o alertar caso a página não redirecionada
